...
import { fallbackMoviePoster, fallbackPersonImage, fetchPersonDetails, fetchPersonMovies, image342 } from '../api/moviedb';
                ...
                loading ? (
                    ...
                    <View>
                        ...
                        <View className="mt-6">
                            ...
                            <Text className="text-base text-neutral-500  text-center">{person?.place_of_birth}
                        ...
                        <View className="mx-3 mt-6 p-4 flex-row justify-between items-center bg-neutral-700 rounded-full">
                            ...
                            <View className="border-r-2 border-r-neutral-400 px-2 items-center">
                                ...
                                <Text className="text-neutral-300 text-sm">{person?.birtday}</Text>
                            </View>
                            <View className="border-r-2 border-r-neutral-400 px-2 items-center">
